...
기획 의도: 한국인의 식생활에서 가장 비중이 높은 식재료들 중 기후 변화에 민감한 농산물들의 가격 형성 메커니즘을 데이터로 이해하고, 조달 리스크를 최소화하는 의사결정 지원 도구를 구축함.
...
배추: 기후에 민감하고 부패가 빨라 실시간 수급 현황이 가격에 즉각 반영되는 대표적인 품목입니다.

양파: 저장성이 매우 뛰어나 장기적인 재고 관리가 가능하며, 가격 흐름이 비교적 완만한 특성을 가집니다.

무: 수급 조절이 필요한 주요 근채류로서 배추와 양파 사이의 중간적인 변동성을 보여주는 지표로 활용됩니다.
